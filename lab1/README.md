...
В целом это было не так сложно, как казалось на первый взгляд. Или это последствия обучения в ИТМО и меня приучили страдать и терпеть.

**когда сделал лабу и понял что зря боялся и откладывал на последний момент потому что она вполне себе выполнимая и вообще интересная**
![bg,f8f8f8-flat,750x,075,f-pad,750x1000,f8f8f8](https://github.com/user-attachments/assets/5f984c79-42be-4819-addf-b221516db270)
